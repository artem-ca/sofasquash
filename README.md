...
Сайт sofasquash.ru оформлен в премиальной палитре **Obsidian Black & Luxury Gold** и оптимизирован под любые устройства — от больших мониторов до экранов смартфонов (чтобы правила можно было быстро проверить прямо на корте).
