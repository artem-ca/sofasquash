...
export default function RulesPage() {
  ...
  return (
    <div className='flex min-h-[calc(100vh-4rem)] font-sans antialiased selection:bg-amber-500/30'>
      ...
      <main className='lg:ml-64 flex-1 px-6 py-12 lg:px-16 lg:py-20 max-w-4xl'>
        ...
        <section id='sec-1' className='scroll-mt-24 mb-16'>
          ...
          >
            ...
            <p>
              <strong>1.2.</strong> Каждый розыгрыш начинается с подачи. После
              этого игроки поочередно совершают удары по мячу до тех пор, пока
              розыгрыш не будет завершен.
            </p>
            <p>
          ...
          >
            Сквош — бесконтактный спорт. Вы обязаны уступать дорогу сопернику и
            останавливать замах, если есть малейший риск нанести травму ракеткой
            или мячом.
          </KeyTakeaway>
        </section>
        ...
        <section id='sec-2' className='scroll-mt-24 mb-16'>
          ...
          >
            <p>
              ...
              (Point-A-Rally). Победитель каждого розыгрыша получает ровно одно
              очко.
            </p>
            <p>
              <strong>2.2.</strong> Гейм выигрывает игрок, первым набравший 11
              очков, кроме ситуации «10-10». При равном счете 10-10 игра
        ...
        <section id='sec-3' className='scroll-mt-24 mb-16'>
          ...
          >
            <p>
              <strong>3.1.</strong> В состав судейской коллегии входят Рефери и
              Маркер. Оба обязаны вести счет встречи и контролировать
              правильность игры.
            </p>
            <p>
              <strong>3.2.</strong> При отсутствии возможности назначить двух
              судей, один арбитр совмещает обязанности.
            </p>
            <p>
            ...
            <p>
              <strong>3.4.</strong> Рефери принимает окончательные решения по
              спорным моментам (Let, Stroke, поведение). Решение Рефери является
              финальным.
            </p>
          </div>
          <KeyTakeaway
          ...
          >
            ...
            игру и подать апелляцию Рефери.
          </KeyTakeaway>
        </section>
        ...
        <section id='sec-4' className='scroll-mt-24 mb-16'>
          ...
          >
            <p>
              ...
              предоставляется совместная разминка на корте продолжительностью
              ровно 5 минут.
            </p>
            <p>
          ...
          <KeyTakeaway
            ...
            isDarkMode={isDarkMode}
          >
            Профессиональный мяч практически не прыгает в холодном состоянии. 5
            минут разминки нужны не только вашим мышцам, но и молекулам резины
            внутри мяча.
          </KeyTakeaway>
        </section>
        ...
        <section id='sec-5' className='scroll-mt-24 mb-16'>
          ...
          >
            ...
            <p>
              <strong>5.2.</strong> При переходе подачи подающий выбирает любой
              квадрат (левый или правый). При выигрыше очков он обязан каждый
              раз менять квадрат.
            </p>
            <p>
              <strong>5.3.</strong> В момент удара хотя бы одна нога подающего
              должна полностью находиться внутри квадрата подачи (не наступая на
              его линии).
            </p>
            <p>
              <strong>5.4.</strong> Подача правильная, если мяч направлен прямо
              в переднюю стену выше средней линии подачи и ниже линии{' '}
        ...
        <section id='sec-6' className='scroll-mt-24 mb-16'>
          ...
          >
            <p>
              ...
              поочередно. Розыгрыш длится до первой ошибки одного из игроков.
            </p>
            <p>
              <strong>6.2.</strong> Удар правильный, если мяч встречен ракеткой
              до второго касания пола, летит напрямую или через боковые/заднюю
              стены в переднюю стену выше звуковой панели (
              <GlossaryTerm term='жестянки' isDarkMode={isDarkMode} /> / tin) и
              ниже линии аута.
            </p>
            <p>
              <strong>6.3.</strong> Мяч считается вышедшим из игры при касании
              любой линии <GlossaryTerm term='аута' isDarkMode={isDarkMode} />,
              потолка, звуковой панели (
              <GlossaryTerm term='жестянки' isDarkMode={isDarkMode} />) или пола
              до касания передней стены.
            </p>
          </div>
          <KeyTakeaway
            title='Линия — это аут!'
            ...
            isDarkMode={isDarkMode}
          >
            Все линии разметки на стенах корта (включая верхнюю планку жестянки)
            считаются зоной аута. Задевание линии мячом означает проигрыш очка.
          </KeyTakeaway>
        </section>
        ...
        <section id='sec-7' className='scroll-mt-24 mb-16'>
          ...
          >
            <p>
              ...
              и началом первого розыгрыша матча составляет строго 60 секунд.
            </p>
            <p>
              <strong>7.2.</strong> Между всеми геймами игрокам предоставляется
              перерыв ровно 2 минуты (120 секунд).
            </p>
            <p>
        ...
        <section id='sec-8' className='scroll-mt-24 mb-16'>
          ...
          >
            <p>
              <strong>8.1.</strong> Игрок, совершивший удар, обязан предоставить
              сопернику: свободную видимость мяча (fair view), беспрепятственный
              доступ (access), пространство для замаха и удара (reasonable
              swing), а также свободный коридор для полета мяча к передней
              стене.
            </p>
            <p>
            ...
            <ul className='list-disc pl-5 space-y-2'>
              <li>
                ...
                или игрок симулировал её, или мяч было невозможно догнать.
                Выигрыш очка соперником.
              </li>
              <li>
                <strong>
                  <GlossaryTerm term='Let' isDarkMode={isDarkMode} /> (Лет):
                </strong>{' '}
                Случайная помеха. Игрок мог нанести удар, но остановился ради
                безопасности. Переигровка розыгрыша.
              </li>
              <li>
                <strong>
        ...
        <section id='sec-9' className='scroll-mt-24 mb-16'>
          ...
          >
            <p>
              ...
              и касается соперника, его экипировки или одежды:
            </p>
            <ul className='list-disc pl-5 space-y-2'>
              <li>
                Если удар летел напрямую в переднюю стену — ударившему игроку
                присуждается <strong>Stroke</strong> (очко).
              </li>
              <li>
          ...
          >
            ...
            стены, очко ваше. Но если вы сами задели себя мячом — очко
        ...
        <section id='sec-10' className='scroll-mt-24 mb-16'>
          ...
          >
            ...
            апелляция больше не принимается.
          </KeyTakeaway>
        </section>
        ...
        <section id='sec-12' className='scroll-mt-24 mb-16'>
          ...
          >
            <p>
              ...
              (например, влага на паркете или протечка потолка), Рефери обязан
              немедленно остановить матч до устранения проблемы.
            </p>
            <p>
              <strong>12.2.</strong> Если во время розыгрыша у игрока выпадает
              личный предмет (резинка для волос, защитные очки) — игра
              останавливается:
            </p>
            <ul className='list-disc pl-5 space-y-2'>
              <li>
        ...
        <section id='sec-13' className='scroll-mt-24 mb-16'>
          ...
          >
            <p>
              ...
              кровотечения Рефери обязан немедленно остановить матч. Игрок не
              имеет права находиться на корте с открытой раной. Ему
            ...
            <ul className='list-disc pl-5 space-y-2'>
              ...
              <li>
                <strong>Собственная травма (судорога):</strong> Игроку дается 3
                минуты. Если не готов играть, он может сдать гейм (0-11) и взять
                2 минуты перерыва, либо признать поражение.
              </li>
            </ul>
          </div>
          <KeyTakeaway
